...
if __name__ == '__main__':
    ...
    # 加载训练数据
    train_iter = load_data(batch_size, target_num)
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 10 == 0:
            if target_num == 'one':
                net_name = 'net/one_target/net_' + str(epoch + 1) + '.pkl'
            elif target_num == 'two':
                net_name = 'net/two_target/net_' + str(epoch + 1) + '.pkl'
            else:
                net_name = 'net/one_improve/net_' + str(epoch + 1) + '.pkl'
